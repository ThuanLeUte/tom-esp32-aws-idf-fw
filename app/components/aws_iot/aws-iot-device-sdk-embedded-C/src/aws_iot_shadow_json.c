...
IoT_Error_t aws_iot_shadow_add_desired(char *pJsonDocument, size_t maxSizeOfJsonDocument) {
	IoT_Error_t ret_val = SUCCESS;
	size_t tempSize = 0;
...
IoT_Error_t aws_iot_shadow_add_reported(char *pJsonDocument, size_t maxSizeOfJsonDocument) {
	IoT_Error_t ret_val = SUCCESS;
...
static jsmntok_t jsonTokenStruct[MAX_JSON_TOKEN_EXPECTED + 200];
